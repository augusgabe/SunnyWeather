...
private val sky = mapOf(
    "CLEAR_DAY" to Sky("晴", R.drawable.bg_clear_day,R.drawable.bg_clear_day),
    ...
    "MODERATE_SNOW" to Sky("中雪",R.drawable.ic_moderate_snow,R.drawable.ic_moderate_snow),
    ...
    "MODERATE_HAZE" to Sky("中毒雾霾",R.drawable.ic_moderate_haze,R.drawable.bg_fog),
